...
<head>
	<!-- Head tags -->
	<?php include_once include_includeFile("/public/head-tags.php"); ?>
</head>

<body>
	<!-- Navbar -->
	<?php include_once include_includeFile("/public/navbar.php"); ?>
	<!-- Top Section -->
	...
	<!-- Footer -->
	<?php include_once include_includeFile("/public/footer.php"); ?>
</body>
</html>